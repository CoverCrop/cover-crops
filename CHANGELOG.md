...
### Fixed
- Street map overlay is not showing correctly [#1](https://github.com/CoverCrop/cover-crops/issues/1)

## [1.9.0] - 2022-11-30

### Added

- Land parcel data for Indiana [CCROP-422](https://opensource.ncsa.illinois.edu/jira/browse/CCROP-422)

## [1.8.0] - 2022-09-30

### Changed
- Development congfiguration to use development geoserver [CCROP-406](https://opensource.ncsa.illinois.edu/jira/browse/CCROP-406)
...
- Text to landing page and tooltips to explain the recent changes related to DSSAT and weather forecasting [CCROP-375](https://opensource.ncsa.illinois.edu/jira/browse/CCROP-375)
