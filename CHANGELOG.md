...
### Security
- Updated npm packages with vulnerabilities. Also updated "openlayers" to "ol" and all its reference methods [CCROP-312](https://opensource.ncsa.illinois.edu/jira/browse/CCROP-312)
